...
public class EDAMDemo {
    ...
    private static final String AUTH_TOKEN = "S=s1:U=934d7:E=16120bd6219:C=159c90c32e8:P=1cd:A=en-devtoken:" +
            "V=2:H=7122c7783d7d70457e0a11b24eafbbda";
